...
public class WrapperClass {
    public static void main(String[] args) {
        ...
        //Wrapper Class'lar non-primitive'dir o yuzden memory'de cok yer kaplarlar, o yuzden sart degilse
...
byte s=Byte.MAX_VALUE;
      ...
      String t=  tv.replace("$","");
        String ra=radio.replace("$","");
        int toplam=Integer.valueOf(t)+Integer.valueOf(ra);
